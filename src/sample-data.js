export const menus = [
    {
        ...
        name: '시스템 관리자',
        i18code: 'ui.title.realtimeAdmin',
        type: 'dashboard',
        url: '/dashboard/realtimeAdmin',
        imageUrl: '/images/SystemAdmin@2x.png',
        order: 0,
        enable: 1,
        platforms: ['java'],
        groups: null,
    ...
    },
    {
        ...
        name: '시스템 관리자 (리소스)',
        i18code: 'ui.title.realtimeAdmin.resource',
        type: 'dashboard',
    ...
    },
    {
        ...
        name: 'Front 통합 대시보드',
        i18code: 'ui.title.realtimeAdmin.front',
        type: 'dashboard',
        url: '/dashboard/realtimeAdmin_front',
        imageUrl: '/images/SystemAdmin@2x.png',
        order: 4,
        enable: 1,
        platforms: ['java', 'php', 'net'],
        groups: null,
        description: null,
