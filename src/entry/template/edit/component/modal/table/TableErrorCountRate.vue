<template>
    ...
    >
        <template #subject>
            {{ i18n.table }} - {{ i18n.errorRate }} ({{ i18n.searchDB }})
        </template>
        <template #contents>
...
export default {
    ...
    computed: {
        ...mapState({
            ...
            showRate: state => state.showRate || false,
        }),
    },
    ...
    data() {
        return {
            i18n: {
                errorRate: i18n.get('ui.title.dberror.rate'),
                table: i18n.get('ui.label.table'),
                searchDB: i18n.get('ui.label.search.db'),
                showRate: i18n.get('ui.label.showRate'),
