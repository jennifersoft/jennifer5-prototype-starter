        ...
        <div class="chart-grid">
            <div class="chart-box">
                <div class="total selected">
                    <span>{{ i18n.cumulativeCalls }}</span>
                    <span>{{ totalDataInMonth.searchMonth.total_service_count | toLocaleString }}</span>
                </div>
                ...
                <div class="total compared">
                    <div class="values">
                        <span>{{ i18n.previousMonth }} {{ i18n.cumulativeCalls }}</span>
                        <delta-percentage :delta="comparedValue(totalDataInMonth.prevMonth.total_service_count, totalDataInMonth.searchMonth.total_service_count)"/>
                    </div>
                    <span>{{ totalDataInMonth.prevMonth.total_service_count | toLocaleString }}</span>
                </div>
                <div class="total compared">
                    <div class="values">
                        <span>{{ i18n.previousMonth }} {{ i18n.callCount }}</span>
                        <delta-percentage :delta="comparedValue(totalDataInMonth.prevMonth.service_count, totalDataInMonth.searchMonth.service_count)" />
                    </div>
                    <span>{{ totalDataInMonth.prevMonth.service_count | toLocaleString }}</span>
                </div>
            </div>
            <div class="chart-box">
                <div class="total selected">
                    <span>{{ i18n.cumulativeVisitor }}</span>
                    <span>{{ totalDataInMonth.searchMonth.total_visit_day | toLocaleString }}</span>
                </div>
                <div class="total compared">
                ...
                <div class="total compared">
                    <div class="values">
                        <span>{{ i18n.previousMonth }} {{ i18n.cumulativeVisitor }}</span>
                        <delta-percentage :delta="comparedValue(totalDataInMonth.prevMonth.total_visit_day, totalDataInMonth.searchMonth.total_visit_day)" />
                    </div>
                    <span>{{ totalDataInMonth.prevMonth.total_visit_day | toLocaleString }}</span>
                </div>
                <div class="total compared">
                    <div class="values">
                        <span>{{ i18n.previousMonth }} {{ i18n.visitCount }}</span>
                        <delta-percentage :delta="comparedValue(totalDataInMonth.prevMonth.visit_day, totalDataInMonth.searchMonth.visit_day)" />
                    </div>
                    <span>{{ totalDataInMonth.prevMonth.visit_day | toLocaleString }}</span>
                </div>
            </div>
            <div class="chart-box">
                <div class="total selected">
                ...
                <div class="total compared">
                    <div class="values">
                        <span>{{ i18n.previousMonth }}</span>
                        <delta-percentage :delta="comparedValue(totalDataInMonth.prevMonth.error_count, totalDataInMonth.searchMonth.error_count)" />
                    </div>
                    <span>{{ totalDataInMonth.prevMonth.error_count | toLocaleString }}</span>
                </div>
            </div>
            <div class="chart-box">
                <div class="total selected">
                ...
                <div class="total compared">
                    <div class="values">
                        <span>{{ i18n.previousMonth }}</span>
                        <delta-percentage :delta="comparedValue(totalDataInMonth.prevMonth.service_rate, totalDataInMonth.searchMonth.service_rate)" />
                    </div>
                    <span>{{ totalDataInMonth.prevMonth.service_rate | toLocaleString }}</span>
                </div>
            </div>
            ...
            <div class="chart-box">
                ...
                <div class="total compared">
                    <div class="values">
                        <span>{{ i18n.previousMonth }}</span>
                        <delta-percentage :delta="comparedValue(totalDataInMonth.prevMonth.service_time, totalDataInMonth.searchMonth.service_time)" />
                    </div>
                    <span>{{ totalDataInMonth.prevMonth.service_time | toLocaleString }}</span>
                </div>
            </div>
            <div class="chart-box">
                <div class="total selected">
                ...
                <div class="total compared">
                    <div class="values">
                        <span>{{ i18n.previousMonth }}</span>
                        <delta-percentage :delta="comparedValue(totalDataInMonth.prevMonth.concurrent_user, totalDataInMonth.searchMonth.concurrent_user)" />
                    </div>
                    <span>{{ totalDataInMonth.prevMonth.concurrent_user | toLocaleString }}</span>
                </div>
            </div>
        </div>
    </section>
...
export default {
    ...
    data() {
        ...
        return {
            ...
            i18n: {
                ...
                previousMonth: i18n.get('ui.label.time.previousMonth'),
                cumulativeCalls: i18n.get("ui.label.cumulativeCalls"),
                callCount: i18n.get('ui.label.averageDailyCalls'),
                cumulativeVisitor: i18n.get("ui.label.visitor.total"),
    ...
    computed: {
        ...
        peakStartIndexInDay() {
            const searchTime = this.searchTimeInMonthly;
        ...
        labelsInHourOrDay() {
            return Array.from(
                new Array(this.countMonthlyData).keys()
            ).map(index =>
                (index + 1) % 2 === 0
