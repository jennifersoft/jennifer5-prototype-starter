...
export default {
    ...
    props: {
        ...
        type: {
            ...
            validator(t) {
                return (
                    ['default', 'space', 'icon', 'checkbox', 'switch'].indexOf(
                        t
                    ) !== -1
    ...
    computed: {
        ...
        cssValues() {
            const paddingLeft =
                this.getSize === 'large' || this.getSize === 'normal' ? 16 : 8;
            let paddingRight =
                this.getSize === 'large' || this.getSize === 'normal' ? 48 : 32;
            const paddingTop = 8;
            ...
            const rowHeight =
                this.getSize === 'large'
                    ...
                    : 24;
            const headerHeight =
                this.getSize === 'large' || this.getSize === 'normal' ? 24 : 20;
