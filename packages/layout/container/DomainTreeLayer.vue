...
export default {
    ...
    computed: {
        ...
        domainTreeData() {
            ...
            return this.domainList.map((d, i) => {
                let noInteraction =
                ...
                return {
                    ...
                    resourceType: d.data.sid === -1 ? 'domain-group' : 'domain',
                    label: d.label,
                    treeIndex: d.treeIndex,
                ...
                return d.resourceType === 'domain' ? this.filterIgnoringCase(d.label, this.searchText)
                    : arr.filter(e => e.data.index.startsWith(d.data.index)) // filter children
                        .some(e => this.filterIgnoringCase(e.label, this.searchText));
            });
        },
    },
    data() {
